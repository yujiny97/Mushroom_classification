...
filepath='/home/yujinlee/gongmo/0714newversion/weight/wfile-{epoch:02d}-{val_accuracy}.h5'
...
with open("/home/yujinlee/gongmo/multiclass/weight/ver3/model_mashroomv3.json", "w") as json_file:
    json_file.write(model_json)

#weight load (currently made weight file and train more)
#model.load_weights("./weight/ver3/mashroom_weight-01-0.7786458134651184.h5")
